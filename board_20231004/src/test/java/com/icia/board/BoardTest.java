...
public class BoardTest {
    ...
    @Test
    //게시글 50개 저장하기
    public BoardDTO createData(int i) {
        BoardDTO boardDTO = new BoardDTO();
        boardDTO.setBoardPass("TestBoardPass" + i);
        boardDTO.setBoardTitle("TestBoardTitle" + i);
        boardDTO.setBoardWriter("TestBoardWriter" + i);
        boardDTO.setBoardContents("TestBoardContents" + i);
        return boardDTO;
    }
    ...
    public void saveData() {
        IntStream.rangeClosed(1, 50).forEach(i -> {
            boardService.save(createData(i));
        });
    }
